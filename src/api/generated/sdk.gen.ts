 ...
 */
export const patchApiOrdersByIdReturn = <ThrowOnError extends boolean = true>(options: Options<PatchApiOrdersByIdReturnData, ThrowOnError>): RequestResult<PatchApiOrdersByIdReturnResponses, PatchApiOrdersByIdReturnErrors, ThrowOnError> => (options.client ?? client).patch<PatchApiOrdersByIdReturnResponses, PatchApiOrdersByIdReturnErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
